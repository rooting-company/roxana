...
public class GenericParameterFinder implements ParameterFinderStrategy {
    ...
    private static final String EXCEPTION_WHEN_PASSING_PARAMETER = "Exception when passing parameter: ";
    ...
    public List<Parameter> findParameters() {
        ...
        fields.forEach(field -> {
            ...
            try {
                ...
                // It is not going to enter here, because the field belongs to the given object,
                // and this method change the field accessibility through "setAccessible".
    ...
    private String getFailToFindParameterMessage(final Field field) {
        return EXCEPTION_WHEN_PASSING_PARAMETER + field.getDeclaringClass() + "." + field.getName();
    }
