...
import static br.com.rooting.roxana.parameter.Parameter.*;
...
enum TranslationEnum {
    ...
    TranslationEnum(final String key,
    ...
    private String getPtBR() {
        return ptBR;
    }

    private String getEnUS() {
        return enUS;
    }

    private String getDeDE() {
        return deDE;
    }

    private String getJaJP() {
        return jaJP;
    }
