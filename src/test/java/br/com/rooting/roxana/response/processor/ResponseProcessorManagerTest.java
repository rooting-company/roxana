...
class ResponseProcessorManagerTest extends UnitTest<ResponseProcessorManager> {
    ...
    // TODO test if the not business exception was logged correctly.
    @Test
    ...
    private static class MockedBusinessException extends Exception {
        ...
        private static final String ROXANA_KEY = getInterpolatedKeyOf(MockedBusinessException.class.getName());
    ...
    private static class MockedMultiBusinessException extends Exception {
        ...
        private MockedMultiBusinessException(Exception... exceptions) {
