...
class ConstraintValidatorResponseProcessorTest extends UnitTest<ConstraintValidatorResponseProcessor> {
    ...
    @Test
    void processConstraintViolationExceptionTest() throws Exception {
        RoxanaProperties roxanaProperties = this.getRoxanaProperties(false);
        ConstraintValidatorResponseProcessor processor = this.getResponseProcessorForTest(roxanaProperties, mock(ResponseProcessorManager.class));
    ...
    private ConstraintValidatorResponseProcessor getResponseProcessorForTest(final RoxanaProperties roxanaProperties,
